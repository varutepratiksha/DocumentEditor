...
import { IoEye, IoEyeOff } from "react-icons/io5"; // Added IoEyeOff for toggling password visibility
...
const Login = () => {
  ...
  const [showPwd, setShowPwd] = useState(false); // State to toggle password visibility
      ...
      <div className="flex overflow-hidden items-center w-screen justify-center flex-col h-screen bg-[#F0F0F0]">
        <div className="flex w-full items-center">
          ...
          <div className="right flex items-end justify-end">
            <img className='w-[35vw]' src={rightIMG} alt="Login Illustration" />
          </div>
        </div>
      </div>
    </>
